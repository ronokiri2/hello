...
// Таже самая функция, но только для постера про пингвинов и с усилением чтобы сильнее был параллакс эффект
// надо переписать так чтобы не повторяться
function atvImg2(){
	...
	var d = document,
		...
		htm = d.getElementsByTagName('html')[0],
		win = window,
		imgs = d.querySelectorAll('.atvImg2'),
		totalImgs = imgs.length,
		supportsTouch = 'ontouchstart' in win || navigator.msMaxTouchPoints;
